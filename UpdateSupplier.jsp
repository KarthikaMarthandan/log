...
<div class="container">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" readonly id="suppliername" name="suppliername" value="${supplierInfo.supplierId}"/>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="suppliername" name="suppliername" value="${supplierInfo.supplierName}"/>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="supplierlocation" name="supplierlocation" value="${categoryInfo.supplierLocation}"/>
    </div>
  </div>
